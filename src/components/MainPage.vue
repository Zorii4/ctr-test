<template>
  <div>
    <h1>Уведомления</h1>
    <div v-if="!props.normalizeData" class="loading">Загрузка...</div>
    <div v-else>
      ...
      <div class="btn-container">
        <BaseSelect
          ...
          @reset="selectedValue = ''"
        />
        <button class="reload-btn" @click="emit('fetchingData')">
...
<script setup lang="ts">
  ...
  import { ICases, INormalizeData } from "../interfaces/notificationsList"
